        ...
        <table id="tab1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr class="container-td">
                    ...
                    <td><?php echo $stat->sender_login; ?></td>
                    ...
                    <td>
                        <a href="<?php echo site_url('admin/delete_statement/'. $stat->id) ?>" class="btn btn-secondary btn-sm" onclick="return confirm('Оё хориҷ кардан мехоҳед?')">
                            <i class="fas fa-trash"></i> Хориҷ
                        </a>
                        <a href="<?= base_url('admin/update_statement/' . $stat->id) ?>" class="btn btn-warning btn-sm" style="margin-top: 10px;">
