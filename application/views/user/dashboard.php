...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto" >
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="tel:<?= $this->session->userdata('phone'); ?>">
                        ...
                        <a href="<?= base_url('user/profile')?>" class="nav-link" data-load="content">
    ...
    <div class="container">
        <a href="<?= base_url('user/my_applications'); ?>" class="btn btn-primary mb-3" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати аризаҳо</a>
        <a href="<?= base_url('user/submit') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Аризаи нав +</a>
        <a href="<?= base_url('user/my_statements'); ?>" class="btn btn-primary mb-3" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати баёнотҳо</a>
        <a href="<?= base_url('user/submit_statement'); ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Баёноти нав +</a>
        <!-- <a href="<?= base_url('user/my_applications'); ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Аризаҳои ман</a>-->
