...
<body style="">
    ...
    <div class="container mt-0 pt-3" style="width: 600px;">
        ...
        <form action="<?php echo site_url('admin/submit'); ?>" method="POST">
            <div class="mb-4">
            ...
            <div class="mb-4" >
                ...
                <select name="app_for" class="form-select" id="reasonSelect" required>
                    <option value=""></option>
                    ...
                    <option value="Маросими дафн">Ягон кори зарур доштан</option>
                    <option value="Маросими дафн">Шароити оилавӣ</option>
                </select>
