...
<body>
    ...
    <div class="container">
        <h2 class="text-center">Баёнот супоридан</h2>
        ...
        <form action="<?php echo site_url('admin/submit_statement'); ?>" method="POST">
            <div class="mb-4">
            ...
            <div class="mb-4" >
                ...
                <select name="stat_for" class="form-select" id="reasonSelect" required>
                    <option value=""></option>
                    <option value="Вайронкунии қоидаи дарс">Вайронкунии қоидаи дарс</option>
                    <option value="Бо пойафзоли манъшуда омадан">Бо пойафзоли манъшуда омадан</option>
                    <option value="Бо шими манъшуда омадан">Бо шими манъшуда омадан</option>
                    <option value="Бо риши дароз омадан">Бо риши дароз омадан</option>
                    <option value="Бо бо мӯйисари дароз омадан">Бо бо мӯйисари дароз омадан</option>
                </select>
            </div>

            <div class="mb-4">
                <label class="form-label">Матн:</label>
                <textarea name="statement_text" class="form-control" rows="4" required></textarea>
            </div>
