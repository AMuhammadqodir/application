<?php if ($this->session->userdata('userstatus') !== 'dekan'): ?>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto" >
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="tel:<?= $this->session->userdata('phone'); ?>">
                        ...
                        <a href="<?= base_url('dekan/profile')?>" class="nav-link" data-load="content">
    ...
    <div class="container">
        <a href="<?= base_url('dekan/application') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати аризаҳо</a>
        <a href="<?= base_url('dekan/submit') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Аризаи нав +</a>
        <a href="<?= base_url('dekan/statement') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати баёнотҳо</a>
        <a href="<?= base_url('dekan/submit_statement') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Баёноти нав +</a>
        <h3>
        <?php
            if ($admin_info) {
