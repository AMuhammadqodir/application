<?php if ($this->session->userdata('userstatus') !== 'rtalim'): ?>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <ul class="navbar-nav ml-auto" >
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="tel:<?= $this->session->userdata('phone'); ?>">
                        ...
                        <a href="<?= base_url('r_talim/profile')?>" class="nav-link" data-load="content">
    ...
    <div class="container">
        <a href="<?= base_url('r_talim/application') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати аризаҳо</a>
        <a href="<?= base_url('r_talim/submit') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Аризаи нав +</a>
        <a href="<?= base_url('r_talim/statement') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Рӯйхати баёнотҳо</a>
        <a href="<?= base_url('r_talim/submit_statement') ?>" class="btn btn-primary mb-3" style="margin-top: 40px;">Баёноти нав +</a>
        <h3>
        <?php
            if ($admin_info) {
